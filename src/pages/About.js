...
import brandtCode from '../assets/brandtCode.jpeg';

function About () {
    return (
        <div>
            <h2 className='about-title'>Hi, I'm Brandt!</h2>
            <img src={brandtCode} className='profile-img' alt='Brandt Cox'/>
            <section className='about-container'>
                <p className='p-1'> I'm from Louisiana and I currently reside in SLC, Utah. Within the past two years my interest with coding began with attending an online webinar with SheCodes which my wife didn't want to attend so she handed the baton to me; it was then I realized how fun this nerdy stuff really is. I then began teaching myself to code using Codecademy's platform which has been a great learning experience. I wanted to accelerate and expand my learning in the field of software development which led me to attend the University of Utah Full-Stack Web Development Boot camp. During my 6 months in the boot camp I got to meet really great friends and work with them in a fast paced curriculum along with great TAs to make my experience enjoyable. With them I learned to work in a team environment and to have effective communication skills so that we're all on track to meet our planned goal within projects and graduation itself. </p>
